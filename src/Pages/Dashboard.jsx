                ...
                <Card body className='border-0 mb-3' style={{boxShadow: '0 0 30px 2px rgb(233,233,233)'}}>
                    <div className='d-flex flex-row'>
                        ...
                        <div className='ml-3 w-100' style={{marginTop: '-1px'}}>
                            ...
                            <Row className='mt-n3 d-flex align-items-center'>
                                <Col xs='auto'>
                                    <Label for='distance' className='text-secondary m-0' style={{fontSize: '.7rem'}}>Distance</Label>
                                    <div className='m-0 mt-n1' id='distance'>{post.distanceValue + ' ' + post.distanceUnit}</div>
                                </Col>
                                <div style={{height: '25px', width: '1px', marginTop: '5px', backgroundColor: 'rgb(211,211,211)'}}></div>
                                <Col xs='auto'>
                                    <Label for='time' className='text-secondary m-0' style={{fontSize: '.6rem'}}>Time</Label>
                                    <div className='m-0 mt-n1' id='distance' style={{fontSize: '1.1rem'}}>{
                                ...
                                <div style={{height: '25px', width: '1px', marginTop: '5px', backgroundColor: 'rgb(211,211,211)'}}></div>
                                <Col xs='auto'>
                                    <Label for='speed' className='text-secondary m-0' style={{fontSize: '.7rem'}}>Avg. Velocity</Label>
