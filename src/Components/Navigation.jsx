...
class Navigation extends React.Component {
    ...
    render() {
        ...
        return (
            <Navbar className='m-0 p-0 sticky-top navbar-dark' style={{ backgroundColor: 'black' }} expand='md'>
                <Container className='d-flex align-items-center justify-content-between w-100 py-2 px-3 py-md-0 cmw'>
